...
** https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html["Configurazione e individuazione Azure NetApp Files"^]
...
** https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-adding-systems.html["Aggiunta di sistemi Cloud Volumes ONTAP esistenti"^]
** https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html["Alla scoperta dei cluster ONTAP"^]
...
. Nella NetApp Console, seleziona *Sincronizza*.
...
+
Programma:: Scegli una pianificazione ricorrente per le sincronizzazioni future oppure disattiva la pianificazione della sincronizzazione. Puoi pianificare una relazione per sincronizzare i dati anche ogni 1 minuto. Le pianificazioni possono essere impostate anche con frequenza oraria e giornaliera.
+
--
...
NOTE: Le espressioni regolari (o regex) sono diverse dai caratteri jolly o dalle espressioni glob.  Questa funzionalità funziona *solo* con le espressioni regolari.
...
ACL - Elenco di controllo degli accessi:: Copia solo ACL, solo file o ACL e file da un server SMB abilitando un'impostazione quando crei una relazione o dopo averla creata.
+
--
...
Copia e sincronizza avvia la sincronizzazione dei dati tra l'origine e la destinazione. Le statistiche di sincronizzazione sulla durata della sincronizzazione, su eventuali interruzioni e sul numero di file copiati, scansionati o eliminati sono disponibili. Puoi quindi gestire i tuoi link:task-managing-relationships.html["relazioni di sincronizzazione"], link:task-managing-data-brokers.html["gestisci i tuoi broker di dati"] o link:task-managing-reports.html#creating-reports["creare report per ottimizzare le prestazioni e la configurazione"].
...
image:screenshot-sync-data-sense.png["Uno screenshot che mostra la pagina di integrazione NetApp Data Classification visualizzata dopo aver avviato una nuova sincronizzazione direttamente da NetApp Data Classification."]

https://docs.netapp.com/us-en/data-services-data-classification/concept-classification.html["Scopri come avviare una relazione di sincronizzazione da NetApp Data Classification"^].
