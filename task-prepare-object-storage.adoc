...
summary: 'Se si prevede di sincronizzare i dati da un archivio oggetti all"altro (ad esempio, da Amazon S3 ad Azure Blob) utilizzando NetApp Copy and Sync, è necessario preparare il gruppo di broker dati prima di creare la relazione di sincronizzazione.' 
---
= Prepara un broker per la sincronizzazione dello storage a oggetti in NetApp Copy and Sync
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
