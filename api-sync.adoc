...
summary: 'Le funzionalità di copia e sincronizzazione NetApp disponibili tramite l"interfaccia utente Web sono disponibili anche tramite le API RESTful.' 
---
= API di copia e sincronizzazione NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Le funzionalità NetApp Copy e Sync disponibili tramite l'interfaccia utente Web sono disponibili anche tramite l'API RESTful.
...
.Passi
. Ottieni un token utente dalla console NetApp .
+
[source, http]
----
