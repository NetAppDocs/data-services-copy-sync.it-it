...
La funzione Copia e sincronizzazione è disponibile nella console NetApp .  Dal menu di navigazione a sinistra della Console, seleziona *Mobilità* > *Copia e sincronizza*.
